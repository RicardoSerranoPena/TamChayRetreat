                ...
                <div class="row full-height align-items-center">
                  <div class="col-md-3 mx-auto">
                    <ul class="list-unstyled menu">
                      <li class="active"><a href="vn-index.html">nhà<a></li>
  ...
  <section class="section slider-section bg-light">
    <div class="container">
      ...
      <div class="row justify-content-center align-items-left text-center">
        <?php
        $display_in_date = date("d-m-Y", strtotime($_SESSION["checkin_date"]));
        $display_out_date = date("d-m-Y", strtotime($_SESSION["checkout_date"]));
        echo "id xác nhận " . $_SESSION["first_name"] . " " . $_SESSION["last_name"] . " về đặt phòng của bạn<br>";
        echo "từ" . $display_in_date . " đến " . $display_out_date . "<br>";
        echo "ví dụ " . $_SESSION["female_guests"] . " Khách nữ và " . $_SESSION["male_guests"] . " Khách nam <br>";
        echo "id đặt phòng của bạn là: " . $_SESSION["reservation_id"] . "<br>";
        ?>
      </div>
    </div>
    </div>
